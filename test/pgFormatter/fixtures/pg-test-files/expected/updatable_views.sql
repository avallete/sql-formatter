...
CREATE VIEW ro_view12 AS
SELECT
    *
FROM
    generate_series(1, 10) AS g (a);

-- SRF in rangetable
CREATE VIEW ro_view13 AS
SELECT
    a,
    b
FROM (
...
CREATE VIEW ro_view20 AS
SELECT
    a,
    b,
    generate_series(1, a) g
FROM
    base_tbl;
...
-- should fail
CREATE OR REPLACE VIEW rw_view2 AS
SELECT
    *
FROM
    rw_view1
