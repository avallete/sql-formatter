...
FROM
    generate_series(1, 1100) g (i)
    \gexec
    \set ECHO all
INSERT INTO
    extra_wide_table (firstc, lastc)
VALUES
    ('first col', 'last col');
...
CREATE TABLE partitioned (a int) INHERITS (some_table)
PARTITION BY
    LIST (a);

-- cannot use more than 1 column as partition key for list partitioned table
CREATE TABLE partitioned (a1 int, a2 int)
PARTITION BY
    LIST (a1, a2);
...
CREATE TABLE partitioned (a int, b int, c text, d text)
PARTITION BY
    RANGE (
        a oid_ops,
        plusone (b),
...
CREATE TABLE partitioned2 (a int, b text)
PARTITION BY
    RANGE ((a + 1), substr(b, 1, 5));
...
CREATE TABLE part2_1 PARTITION OF partitioned2 FOR
VALUES
FROM
    (-1, 'aaaaa') TO (100, 'ccccc');
...
CREATE TABLE part_p2 PARTITION OF list_parted FOR
VALUES
    IN (2);

CREATE TABLE part_p3 PARTITION OF list_parted FOR
VALUES
    IN ((2 + 1));

CREATE TABLE part_null PARTITION OF list_parted FOR
VALUES
    IN (NULL);
...
CREATE TABLE bools (a bool)
PARTITION BY
    LIST (a);

CREATE TABLE bools_true PARTITION OF bools FOR
VALUES
    IN (1);
...
CREATE TABLE moneyp_10 PARTITION OF moneyp FOR
VALUES
    IN (10);

CREATE TABLE moneyp_11 PARTITION OF moneyp FOR
VALUES
    IN ('11');

CREATE TABLE moneyp_12 PARTITION OF moneyp FOR
VALUES
    IN (to_char(12, '99')::int);
...
CREATE TABLE bigintp_10 PARTITION OF bigintp FOR
VALUES
    IN (10);

-- fails due to overlap:
CREATE TABLE bigintp_10_2 PARTITION OF bigintp FOR
VALUES
    IN ('10');
...
CREATE TABLE part_bogus_expr_fail PARTITION OF range_parted FOR
VALUES
FROM
    (somename) TO ('2019-01-01');

CREATE TABLE part_bogus_expr_fail PARTITION OF range_parted FOR
VALUES
FROM
    (somename.somename) TO ('2019-01-01');
...
VALUES
FROM
    (max(somename)) TO ('2019-01-01');

CREATE TABLE part_bogus_expr_fail PARTITION OF range_parted FOR
VALUES
FROM
    (max('2019-02-01'::date)) TO ('2019-01-01');
...
VALUES
FROM
    (generate_series(1, 3)) TO ('2019-01-01');

-- trying to specify list for range partitioned table
CREATE TABLE fail_part PARTITION OF range_parted FOR
VALUES
    IN ('a');
...
CREATE TABLE hpart_1 PARTITION OF hash_parted FOR
VALUES
WITH
    (MODULUS 10, REMAINDER 0);

CREATE TABLE hpart_2 PARTITION OF hash_parted FOR
VALUES
WITH
    (MODULUS 50, REMAINDER 1);

CREATE TABLE hpart_3 PARTITION OF hash_parted FOR
VALUES
WITH
    (MODULUS 200, REMAINDER 2);

-- modulus 25 is factor of modulus of 50 but 10 is not factor of 25.
CREATE TABLE fail_part PARTITION OF hash_parted FOR
VALUES
WITH
    (MODULUS 25, REMAINDER 3);

-- previous modulus 50 is factor of 150 but this modulus is not factor of next modulus 200.
CREATE TABLE fail_part PARTITION OF hash_parted FOR
VALUES
WITH
    (MODULUS 150, REMAINDER 3);
...
CREATE TABLE fail_part PARTITION OF unparted FOR
VALUES
    IN ('a');
...
CREATE TEMP TABLE temp_parted (a int)
PARTITION BY
    LIST (a);

CREATE TABLE fail_part PARTITION OF temp_parted FOR
VALUES
    IN ('a');
...
CREATE TABLE part_null_z PARTITION OF list_parted2 FOR
VALUES
    IN (NULL, 'z');

CREATE TABLE part_ab PARTITION OF list_parted2 FOR
VALUES
    IN ('a', 'b');

CREATE TABLE list_parted2_def PARTITION OF list_parted2 DEFAULT;

CREATE TABLE fail_part PARTITION OF list_parted2 FOR
VALUES
    IN (NULL);
...
CREATE TABLE fail_part PARTITION OF range_parted2 FOR
VALUES
FROM
    (1) TO (0);
...
CREATE TABLE part0 PARTITION OF range_parted2 FOR
VALUES
FROM
    (minvalue) TO (1);
...
CREATE TABLE part1 PARTITION OF range_parted2 FOR
VALUES
FROM
    (1) TO (10);
...
CREATE TABLE part2 PARTITION OF range_parted2 FOR
VALUES
FROM
    (20) TO (30);

CREATE TABLE part3 PARTITION OF range_parted2 FOR
VALUES
FROM
    (30) TO (40);
...
CREATE TABLE part4 PARTITION OF range_parted2 FOR
VALUES
FROM
    (90) TO (100);

-- now check for multi-column range partition key
CREATE TABLE range_parted3 (a int, b int)
PARTITION BY
    RANGE (a, (b + 1));

CREATE TABLE part00 PARTITION OF range_parted3 FOR
VALUES
FROM
    (0, minvalue) TO (0, maxvalue);

CREATE TABLE fail_part PARTITION OF range_parted3 FOR
VALUES
FROM
    (0, minvalue) TO (0, 1);

CREATE TABLE part10 PARTITION OF range_parted3 FOR
VALUES
FROM
    (1, minvalue) TO (1, 1);

CREATE TABLE part11 PARTITION OF range_parted3 FOR
VALUES
FROM
    (1, 1) TO (1, 10);

CREATE TABLE part12 PARTITION OF range_parted3 FOR
VALUES
FROM
    (1, 10) TO (1, maxvalue);
...
CREATE TABLE h2part_1 PARTITION OF hash_parted2 FOR
VALUES
WITH
    (MODULUS 4, REMAINDER 2);

CREATE TABLE h2part_2 PARTITION OF hash_parted2 FOR
VALUES
WITH
    (MODULUS 8, REMAINDER 0);

CREATE TABLE h2part_3 PARTITION OF hash_parted2 FOR
VALUES
WITH
    (MODULUS 8, REMAINDER 4);

CREATE TABLE h2part_4 PARTITION OF hash_parted2 FOR
VALUES
WITH
    (MODULUS 8, REMAINDER 5);

-- overlap with part_4
CREATE TABLE fail_part PARTITION OF hash_parted2 FOR
VALUES
WITH
    (MODULUS 2, REMAINDER 1);
...
CREATE TABLE part_a PARTITION OF parted FOR
VALUES
    IN ('a');
...
CREATE TABLE part_b PARTITION OF parted (
    ...
    b DEFAULT 1,
    b CHECK (b >= 0),
    CONSTRAINT check_a CHECK (length(a) > 0)) FOR
VALUES
    IN ('b');
...
CREATE TABLE part_b PARTITION OF parted (
    ...
    CONSTRAINT check_a CHECK (length(a) > 0),
    CONSTRAINT check_b CHECK (b >= 0)) FOR
VALUES
    IN ('b');
...
CREATE TABLE fail_part_col_not_found PARTITION OF parted FOR
VALUES
    IN ('c')
PARTITION BY
    RANGE (c);

CREATE TABLE part_c PARTITION OF parted (
    b
    WITH
        OPTIONS NOT NULL DEFAULT 0) FOR
VALUES
    IN ('c')
PARTITION BY
    RANGE ((b));
...
CREATE TABLE part_c_1_10 PARTITION OF part_c FOR
VALUES
FROM
    (1) TO (10);
...
CREATE TABLE parted_notnull_inh_test1 partition of parted_notnull_inh_test (a NOT NULL, b DEFAULT 1) FOR
VALUES
    IN (1);

INSERT INTO
    parted_notnull_inh_test (b)
VALUES
    (NULL);
...
CREATE TABLE parted_collate_must_match1 partition of parted_collate_must_match (a COLLATE "POSIX") FOR
VALUES
FROM
    ('a') TO ('m');

-- on another column
CREATE TABLE parted_collate_must_match2 partition of parted_collate_must_match (b COLLATE "POSIX") FOR
VALUES
FROM
    ('m') TO ('z');
...
PARTITION BY
    range (a COLLATE "POSIX");

-- fail
CREATE TABLE test_part_coll partition of test_part_coll_posix FOR
VALUES
FROM
    ('a' COLLATE "C") TO ('g');
...
-- ok
CREATE TABLE test_part_coll2 partition of test_part_coll_posix FOR
VALUES
FROM
    ('g') TO ('m');
...
-- fail
CREATE TABLE test_part_coll_cast partition of test_part_coll_posix FOR
VALUES
FROM
    (name 'm' COLLATE "C") TO ('s');

-- ok
CREATE TABLE test_part_coll_cast partition of test_part_coll_posix FOR
VALUES
FROM
    (name 'm' COLLATE "POSIX") TO ('s');

-- ok; partition collation silently overrides the default collation of type 'name'
CREATE TABLE test_part_coll_cast2 partition of test_part_coll_posix FOR
VALUES
FROM
    (name 's') TO ('z');
...
CREATE TABLE range_parted4 (a int, b int, c int)
PARTITION BY
    RANGE (abs(a), abs(b), c);

CREATE TABLE unbounded_range_part PARTITION OF range_parted4 FOR
VALUES
FROM
    (MINVALUE, MINVALUE, MINVALUE) TO (MAXVALUE, MAXVALUE, MAXVALUE);

\d+ unbounded_range_part
DROP TABLE unbounded_range_part;

CREATE TABLE range_parted4_1 PARTITION OF range_parted4 FOR
VALUES
FROM
    (MINVALUE, MINVALUE, MINVALUE) TO (1, MAXVALUE, MAXVALUE);

\d+ range_parted4_1
CREATE TABLE range_parted4_2 PARTITION OF range_parted4 FOR
VALUES
FROM
    (3, 4, 5) TO (6, 7, MAXVALUE);

\d+ range_parted4_2
CREATE TABLE range_parted4_3 PARTITION OF range_parted4 FOR
VALUES
FROM
    (6, 8, MINVALUE) TO (9, MAXVALUE, MAXVALUE);
...
CREATE OPERATOR CLASS test_int4_ops FOR TYPE int4 USING btree AS OPERATOR 1 < (int4, int4),
...
CREATE TABLE partkey_t (a int4)
PARTITION BY
    RANGE (a test_int4_ops);

CREATE TABLE partkey_t_1 PARTITION OF partkey_t FOR
VALUES
FROM
    (0) TO (1000);
...
CREATE TABLE parted_col_comment (a int, b text)
PARTITION BY
    LIST (a);
...
CREATE TABLE arrlp12 PARTITION OF arrlp FOR
VALUES
    IN ('{1}', '{2}');
...
CREATE TABLE boolspart (a bool)
PARTITION BY
    list (a);

CREATE TABLE boolspart_t partition of boolspart FOR
VALUES
    IN (TRUE);

CREATE TABLE boolspart_f partition of boolspart FOR
VALUES
    IN (FALSE);
...
CREATE TRIGGER trig_part_create before insert ON tab_part_create FOR each statement
