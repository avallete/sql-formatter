...
-- 	(fkey3)		--> fkeys2 (pkey23)
--
CREATE TRIGGER check_fkeys_pkey_exist before insert
OR
UPDATE ON fkeys FOR each ROW
EXECUTE function check_primary_key ('fkey1', 'fkey2', 'pkeys', 'pkey1', 'pkey2');

CREATE TRIGGER check_fkeys_pkey2_exist before insert
OR
UPDATE ON fkeys FOR each ROW
...
--
CREATE TRIGGER check_fkeys2_pkey_exist before insert
OR
UPDATE ON fkeys2 FOR each ROW
...
--
CREATE TRIGGER check_pkeys_fkey_cascade before delete
OR
UPDATE ON pkeys FOR each ROW
...
-- 		fkeys (fkey3)
--
CREATE TRIGGER check_fkeys2_fkey_restrict before delete
OR
UPDATE ON fkeys2 FOR each ROW
...
CREATE TRIGGER trigger_return_old before insert
OR delete
OR
UPDATE ON trigtest FOR each ROW
...
CREATE TRIGGER ttdummy before delete
OR
UPDATE ON tttest FOR each ROW
EXECUTE procedure ttdummy (price_on, price_off);

CREATE TRIGGER ttserial before insert
OR
UPDATE ON tttest FOR each ROW
...
CREATE TRIGGER before_ins_stmt_trig BEFORE INSERT ON main_table FOR EACH STATEMENT
EXECUTE PROCEDURE trigger_func ('before_ins_stmt');

CREATE TRIGGER after_ins_stmt_trig
AFTER INSERT ON main_table FOR EACH STATEMENT
...
AFTER
UPDATE ON main_table FOR EACH ROW
...
--
CREATE TRIGGER modified_a BEFORE
UPDATE OF a ON main_table FOR EACH ROW WHEN (OLD.a <> NEW.a)
EXECUTE PROCEDURE trigger_func ('modified_a');

CREATE TRIGGER modified_any BEFORE
UPDATE OF a ON main_table FOR EACH ROW WHEN (OLD.* IS DISTINCT FROM NEW.*)
EXECUTE PROCEDURE trigger_func ('modified_any');

CREATE TRIGGER insert_a
AFTER INSERT ON main_table FOR EACH ROW WHEN (NEW.a = 123)
EXECUTE PROCEDURE trigger_func ('insert_a');

CREATE TRIGGER delete_a
AFTER DELETE ON main_table FOR EACH ROW WHEN (OLD.a = 123)
EXECUTE PROCEDURE trigger_func ('delete_a');

CREATE TRIGGER insert_when BEFORE INSERT ON main_table FOR EACH STATEMENT WHEN (TRUE)
EXECUTE PROCEDURE trigger_func ('insert_when');

CREATE TRIGGER delete_when
AFTER DELETE ON main_table FOR EACH STATEMENT WHEN (TRUE)
...
AFTER
UPDATE ON table_with_oids FOR each ROW WHEN (
    new.tableoid = old.tableoid
    AND new.tableoid <> 0)
EXECUTE procedure trigger_func ('after_upd_oid_unchanged');

UPDATE table_with_oids
SET
    a = a + 1;
...
CREATE TRIGGER some_trig_before BEFORE
UPDATE ON some_t FOR EACH ROW
EXECUTE PROCEDURE dummy_update_func ('before');

CREATE TRIGGER some_trig_aftera
AFTER
UPDATE ON some_t FOR EACH ROW WHEN (
    NOT OLD.some_col
    AND NEW.some_col)
...
AFTER
UPDATE ON some_t FOR EACH ROW WHEN (NOT NEW.some_col)
...
-- bogus cases
CREATE TRIGGER error_upd_and_col BEFORE
UPDATE
OR
UPDATE OF a ON main_table FOR EACH ROW
EXECUTE PROCEDURE trigger_func ('error_upd_and_col');

CREATE TRIGGER error_upd_a_a BEFORE
UPDATE OF a,
a ON main_table FOR EACH ROW
EXECUTE PROCEDURE trigger_func ('error_upd_a_a');

CREATE TRIGGER error_ins_a BEFORE INSERT OF a ON main_table FOR EACH ROW
EXECUTE PROCEDURE trigger_func ('error_ins_a');

CREATE TRIGGER error_ins_when BEFORE INSERT
OR
UPDATE ON main_table FOR EACH ROW WHEN (OLD.a <> NEW.a)
EXECUTE PROCEDURE trigger_func ('error_ins_old');

CREATE TRIGGER error_del_when BEFORE DELETE
OR
UPDATE ON main_table FOR EACH ROW WHEN (OLD.a <> NEW.a)
EXECUTE PROCEDURE trigger_func ('error_del_new');

CREATE TRIGGER error_del_when BEFORE INSERT
OR
UPDATE ON main_table FOR EACH ROW WHEN (NEW.tableoid <> 0)
EXECUTE PROCEDURE trigger_func ('error_when_sys_column');

CREATE TRIGGER error_stmt_when BEFORE
UPDATE OF a ON main_table FOR EACH STATEMENT WHEN (OLD.* IS DISTINCT FROM NEW.*)
...
CREATE TRIGGER trigtest_b_row_tg before insert
OR
UPDATE
...
CREATE TRIGGER trigtest_b_stmt_tg before insert
OR
UPDATE
...
CREATE OR REPLACE FUNCTION trigger_data () RETURNS trigger LANGUAGE plpgsql AS $$
...
CREATE TRIGGER show_trigger_data_trig BEFORE INSERT
OR
UPDATE
OR DELETE ON trigger_test FOR EACH ROW
...
CREATE TRIGGER t BEFORE
UPDATE ON trigger_test FOR EACH ROW
...
CREATE TRIGGER serializable_update_trig BEFORE
UPDATE ON serializable_update_tab FOR EACH ROW
...
CREATE TRIGGER z_min_update BEFORE
UPDATE ON min_updates_test FOR EACH ROW
EXECUTE PROCEDURE suppress_redundant_updates_trigger();

\set QUIET false
UPDATE min_updates_test
SET
    f1 = f1;
...
CREATE OR REPLACE FUNCTION view_trigger () RETURNS trigger LANGUAGE plpgsql AS $$
declare
    argstr text := '';
begin
    for i in 0 .. TG_nargs - 1 loop
...
CREATE TRIGGER invalid_trig BEFORE INSERT ON main_view FOR EACH ROW
EXECUTE PROCEDURE trigger_func ('before_ins_row');

CREATE TRIGGER invalid_trig BEFORE
UPDATE ON main_view FOR EACH ROW
EXECUTE PROCEDURE trigger_func ('before_upd_row');

CREATE TRIGGER invalid_trig BEFORE DELETE ON main_view FOR EACH ROW
EXECUTE PROCEDURE trigger_func ('before_del_row');

-- After row triggers aren't allowed on views
CREATE TRIGGER invalid_trig
AFTER INSERT ON main_view FOR EACH ROW
EXECUTE PROCEDURE trigger_func ('before_ins_row');
...
CREATE TRIGGER invalid_trig
AFTER DELETE ON main_view FOR EACH ROW
EXECUTE PROCEDURE trigger_func ('before_del_row');

-- Truncate triggers aren't allowed on views
CREATE TRIGGER invalid_trig BEFORE
TRUNCATE ON main_view
...
CREATE TRIGGER invalid_trig INSTEAD OF INSERT ON main_table FOR EACH ROW
EXECUTE PROCEDURE view_trigger ('instead_of_ins');

CREATE TRIGGER invalid_trig INSTEAD OF
UPDATE ON main_table FOR EACH ROW
EXECUTE PROCEDURE view_trigger ('instead_of_upd');

CREATE TRIGGER invalid_trig INSTEAD OF DELETE ON main_table FOR EACH ROW
EXECUTE PROCEDURE view_trigger ('instead_of_del');

-- Don't support WHEN clauses with INSTEAD OF triggers
CREATE TRIGGER invalid_trig INSTEAD OF
UPDATE ON main_view FOR EACH ROW WHEN (OLD.a <> NEW.a)
EXECUTE PROCEDURE view_trigger ('instead_of_upd');

-- Don't support column-level INSTEAD OF triggers
CREATE TRIGGER invalid_trig INSTEAD OF
UPDATE OF a ON main_view FOR EACH ROW
EXECUTE PROCEDURE view_trigger ('instead_of_upd');
...
CREATE TRIGGER instead_of_insert_trig INSTEAD OF INSERT ON main_view FOR EACH ROW
EXECUTE PROCEDURE view_trigger ('instead_of_ins');

CREATE TRIGGER instead_of_update_trig INSTEAD OF
UPDATE ON main_view FOR EACH ROW
EXECUTE PROCEDURE view_trigger ('instead_of_upd');

CREATE TRIGGER instead_of_delete_trig INSTEAD OF DELETE ON main_view FOR EACH ROW
EXECUTE PROCEDURE view_trigger ('instead_of_del');

-- Valid BEFORE statement VIEW triggers
CREATE TRIGGER before_ins_stmt_trig BEFORE INSERT ON main_view FOR EACH STATEMENT
EXECUTE PROCEDURE view_trigger ('before_view_ins_stmt');

CREATE TRIGGER before_upd_stmt_trig BEFORE
UPDATE ON main_view FOR EACH STATEMENT
EXECUTE PROCEDURE view_trigger ('before_view_upd_stmt');

CREATE TRIGGER before_del_stmt_trig BEFORE DELETE ON main_view FOR EACH STATEMENT
EXECUTE PROCEDURE view_trigger ('before_view_del_stmt');

-- Valid AFTER statement VIEW triggers
CREATE TRIGGER after_ins_stmt_trig
AFTER INSERT ON main_view FOR EACH STATEMENT
...
AFTER DELETE ON main_view FOR EACH STATEMENT
...
INSERT INTO
    country_table (country_name, continent)
VALUES
    ('Japan', 'Asia'),
    ('UK', 'Europe'),
    ('USA', 'North America')
...
CREATE TRIGGER city_insert_trig INSTEAD OF INSERT ON city_view FOR EACH ROW
...
CREATE TRIGGER city_delete_trig INSTEAD OF DELETE ON city_view FOR EACH ROW
...
CREATE TRIGGER city_update_trig INSTEAD OF
UPDATE ON city_view FOR EACH ROW
...
INSERT INTO
    city_view (city_name, population)
VALUES
    ('London', 7556900)
RETURNING
    *;
...
INSERT INTO
    city_view (city_name, country_name)
VALUES
    ('Washington DC', 'USA')
RETURNING
    *;
...
INSERT INTO
    city_view
VALUES
    (234567, 'Birmingham', 1016800, 'UK', 'EU')
RETURNING
    *;
...
OR
UPDATE
OR DELETE ON european_city_view FOR EACH ROW
...
CREATE RULE european_city_insert_rule AS ON INSERT TO european_city_view DO INSTEAD
INSERT INTO
    city_view
VALUES (
        NEW.city_id,
...
CREATE RULE european_city_update_rule AS ON UPDATE TO european_city_view DO INSTEAD
UPDATE city_view
SET
...
CREATE RULE european_city_delete_rule AS ON DELETE TO european_city_view DO INSTEAD
DELETE FROM city_view
WHERE
    city_id = OLD.city_id
RETURNING
...
INSERT INTO
    european_city_view (city_name, country_name)
VALUES
    ('Cambridge', 'USA')
RETURNING
    *;
...
CREATE TRIGGER depth_a_tr before insert ON depth_a FOR each ROW
...
CREATE TRIGGER depth_b_tr before insert ON depth_b FOR each ROW
...
CREATE TRIGGER depth_c_tr before insert ON depth_c FOR each ROW
...
CREATE FUNCTION parent_upd_func () returns trigger language plpgsql AS $$
begin
...
CREATE TRIGGER parent_upd_trig before
UPDATE ON parent FOR each ROW
EXECUTE procedure parent_upd_func ();

CREATE FUNCTION parent_del_func () returns trigger language plpgsql AS $$
begin
...
CREATE TRIGGER parent_del_trig before delete ON parent FOR each ROW
EXECUTE procedure parent_del_func ();

CREATE FUNCTION child_ins_func () returns trigger language plpgsql AS $$
begin
...
CREATE FUNCTION child_del_func () returns trigger language plpgsql AS $$
begin
...
CREATE OR REPLACE FUNCTION parent_del_func () returns trigger language plpgsql AS $$
begin
  delete from child where aid = old.aid;
  if found then
...
CREATE FUNCTION self_ref_trigger_ins_func () returns trigger language plpgsql AS $$
begin
...
CREATE TRIGGER self_ref_trigger_ins_trig before insert ON self_ref_trigger FOR each ROW
EXECUTE procedure self_ref_trigger_ins_func ();

CREATE FUNCTION self_ref_trigger_del_func () returns trigger language plpgsql AS $$
begin
...
CREATE TRIGGER self_ref_trigger_del_trig before delete ON self_ref_trigger FOR each ROW
...
CREATE TRIGGER before_stmt_trigger before
UPDATE ON stmt_trig_on_empty_upd
EXECUTE procedure update_stmt_notice ();

CREATE TRIGGER before_stmt_trigger before
UPDATE ON stmt_trig_on_empty_upd1
EXECUTE procedure update_stmt_notice ();
...
CREATE FUNCTION upsert_before_func () returns trigger language plpgsql AS $$
begin
  if (TG_OP = 'UPDATE') then
...
CREATE TRIGGER upsert_before_trig before insert
OR
UPDATE ON upsert FOR each ROW
EXECUTE procedure upsert_before_func ();

CREATE FUNCTION upsert_after_func () returns trigger language plpgsql AS $$
begin
  if (TG_OP = 'UPDATE') then
...
AFTER
UPDATE ON my_view referencing old TABLE AS old_table FOR each statement
...
CREATE TRIGGER failed before insert
OR
UPDATE
OR delete ON parted_trig FOR each ROW
EXECUTE procedure trigger_nothing ();

CREATE TRIGGER failed instead of
UPDATE ON parted_trig FOR each ROW
EXECUTE procedure trigger_nothing ();

CREATE TRIGGER failed
AFTER
UPDATE ON parted_trig referencing old TABLE AS old_table FOR each ROW
EXECUTE procedure trigger_nothing ();
...
--
CREATE TABLE trigpart (a int, b int)
PARTITION BY
    range (a);

CREATE TABLE trigpart1 partition of trigpart FOR
VALUES
FROM
    (0) TO (1000);
...
CREATE TABLE trigpart2 partition of trigpart FOR
VALUES
FROM
    (1000) TO (2000);
...
ALTER TABLE trigpart attach partition trigpart3 FOR
VALUES
FROM
    (2000) TO (3000);
...
CREATE TABLE parted_stmt_trig1 partition of parted_stmt_trig FOR
VALUES
    IN (1);

CREATE TABLE parted_stmt_trig2 partition of parted_stmt_trig FOR
VALUES
    IN (2);
...
CREATE TABLE parted2_stmt_trig1 partition of parted2_stmt_trig FOR
VALUES
    IN (1);

CREATE TABLE parted2_stmt_trig2 partition of parted2_stmt_trig FOR
VALUES
    IN (2);
...
CREATE TRIGGER trig_ins_before before insert ON parted_stmt_trig FOR each statement
...
UPDATE ON parted_stmt_trig FOR each statement
EXECUTE procedure trigger_notice ();
...
CREATE TRIGGER trig_del_before before delete ON parted_stmt_trig FOR each statement
EXECUTE procedure trigger_notice ();
...
AFTER
UPDATE ON parted_stmt_trig FOR each ROW
EXECUTE procedure trigger_notice ();
...
CREATE TRIGGER trig_ins_before_child before insert ON parted_stmt_trig1 FOR each ROW
EXECUTE procedure trigger_notice ();
...
CREATE TRIGGER trig_upd_before_child before
UPDATE ON parted_stmt_trig1 FOR each ROW
EXECUTE procedure trigger_notice ();
...
CREATE TRIGGER trig_del_before_child before delete ON parted_stmt_trig1 FOR each ROW
EXECUTE procedure trigger_notice ();
...
-- insert/update/delete statement-level triggers on the parent
CREATE TRIGGER trig_ins_before_3 before insert ON parted2_stmt_trig FOR each statement
EXECUTE procedure trigger_notice ();
...
CREATE TRIGGER trig_upd_before_3 before
UPDATE ON parted2_stmt_trig FOR each statement
EXECUTE procedure trigger_notice ();
...
CREATE TRIGGER trig_del_before_3 before delete ON parted2_stmt_trig FOR each statement
EXECUTE procedure trigger_notice ();
...
CREATE TABLE parted_trig_1 partition of parted_trig FOR
VALUES
FROM
    (0) TO (1000)
PARTITION BY
...
CREATE TABLE parted_trig_1_1 partition of parted_trig_1 FOR
VALUES
FROM
    (0) TO (100);

CREATE TABLE parted_trig_2 partition of parted_trig FOR
VALUES
FROM
    (1000) TO (2000);
...
ALTER TABLE parted_irreg_ancestor attach partition parted_irreg FOR
VALUES
FROM
    ('aaaa') TO ('zzzz');
...
ALTER TABLE parted_irreg attach partition parted1_irreg FOR
VALUES
FROM
    ('aaaa') TO ('bbbb');
...
AFTER insert ON parted_irreg FOR each ROW WHEN (
    bark (new.b)
    AND new.a % 2 = 1)
EXECUTE procedure trigger_notice_ab ();
...
ALTER TABLE parted_constr_ancestor attach partition parted_constr FOR
VALUES
FROM
    ('aaaa') TO ('zzzz');
...
ALTER TABLE parted_constr attach partition parted1_constr FOR
VALUES
FROM
    ('aaaa') TO ('bbbb');
...
AFTER insert ON parted_constr DEFERRABLE INITIALLY deferred FOR each ROW WHEN (
    bark (new.b)
    AND new.a % 2 = 1)
EXECUTE procedure trigger_notice_ab ();
...
CREATE TABLE parted_trigger (a int, b text)
PARTITION BY
    range (a);

CREATE TABLE parted_trigger_1 partition of parted_trigger FOR
VALUES
FROM
    (0) TO (1000);
...
ALTER TABLE parted_trigger attach partition parted_trigger_2 FOR
VALUES
FROM
    (1000) TO (2000);
...
AFTER
UPDATE ON parted_trigger FOR each ROW WHEN (
    new.a % 2 = 1
    AND length(old.b) >= 2)
EXECUTE procedure trigger_notice_ab ();

CREATE TABLE parted_trigger_3 (b text, a int)
PARTITION BY
    range (length(b));

CREATE TABLE parted_trigger_3_1 partition of parted_trigger_3 FOR
VALUES
FROM
    (1) TO (3);

CREATE TABLE parted_trigger_3_2 partition of parted_trigger_3 FOR
VALUES
FROM
    (3) TO (5);

ALTER TABLE parted_trigger attach partition parted_trigger_3 FOR
VALUES
FROM
    (2000) TO (3000);
...
CREATE TRIGGER parted_trigger
AFTER
UPDATE of b ON parted_trigger FOR each ROW
EXECUTE procedure trigger_notice_ab ();
...
CREATE TABLE trg_clone1 partition of trg_clone FOR
VALUES
FROM
    (0) TO (1000);
...
CREATE TABLE trg_clone2 partition of trg_clone FOR
VALUES
FROM
    (1000) TO (2000);

CREATE TABLE trg_clone3 partition of trg_clone FOR
VALUES
FROM
    (2000) TO (3000)
PARTITION BY
...
CREATE TABLE trg_clone_3_3 partition of trg_clone3 FOR
VALUES
FROM
    (2000) TO (2100);
...
CREATE TABLE child1 partition of parent FOR
VALUES
    IN ('AAA');
...
ALTER TABLE parent attach partition child2 FOR
VALUES
    IN ('BBB');
...
ALTER TABLE parent attach partition child3 FOR
VALUES
    IN ('CCC');
...
AFTER
UPDATE ON parent referencing old TABLE AS old_table new TABLE AS new_table FOR each statement
...
AFTER
UPDATE ON child1 referencing old TABLE AS old_table new TABLE AS new_table FOR each statement
EXECUTE procedure dump_update ();
...
AFTER
UPDATE ON child2 referencing old TABLE AS old_table new TABLE AS new_table FOR each statement
EXECUTE procedure dump_update ();
...
AFTER
UPDATE ON child3 referencing old TABLE AS old_table new TABLE AS new_table FOR each statement
EXECUTE procedure dump_update ();
...
CREATE TRIGGER intercept_insert_child3 before insert ON child3 FOR each ROW
...
CREATE TABLE child partition of parent FOR
VALUES
    IN ('AAA');
...
ALTER TABLE parent attach partition child FOR
VALUES
    IN ('AAA');
...
AFTER
UPDATE ON my_table referencing old TABLE AS old_table new TABLE AS new_table FOR each statement
EXECUTE procedure dump_update ();
...
--
CREATE TABLE iocdu_tt_parted (a int PRIMARY KEY, b text)
PARTITION BY
    list (a);

CREATE TABLE iocdu_tt_parted1 partition of iocdu_tt_parted FOR
VALUES
    IN (1);

CREATE TABLE iocdu_tt_parted2 partition of iocdu_tt_parted FOR
VALUES
    IN (2);

CREATE TABLE iocdu_tt_parted3 partition of iocdu_tt_parted FOR
VALUES
    IN (3);

CREATE TABLE iocdu_tt_parted4 partition of iocdu_tt_parted FOR
VALUES
    IN (4);
...
AFTER
UPDATE ON iocdu_tt_parted referencing old TABLE AS old_table new TABLE AS new_table FOR each statement
EXECUTE procedure dump_update ();
...
AFTER insert
OR
UPDATE ON my_table referencing new TABLE AS new_table FOR each statement
EXECUTE procedure dump_insert ();
...
AFTER
UPDATE of b ON my_table referencing new TABLE AS new_table FOR each statement
EXECUTE procedure dump_insert ();
...
CREATE TRIGGER trig_table_before_trig before insert
OR
UPDATE
...
AFTER
UPDATE ON trig_table referencing old TABLE AS old_table new TABLE AS new_table FOR each statement
EXECUTE procedure dump_update ();
...
CREATE TRIGGER self_ref_before_trig before delete ON self_ref FOR each statement
