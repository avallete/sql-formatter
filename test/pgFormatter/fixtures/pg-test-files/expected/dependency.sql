...
GRANT
SELECT
    ON TABLE deptest TO GROUP regress_dep_group;

GRANT ALL ON TABLE deptest TO regress_dep_user,
regress_dep_user2;
...
FROM
    pg_type
    JOIN pg_class c ON typrelid = c.oid
WHERE
    typname = 'deptest_t';
...
DROP OWNED BY regress_dep_user2,
regress_dep_user0;
