...
SELECT
    '123456789012345678'::money;

SELECT
    '9223372036854775807'::money;
...
-- rounding
SELECT
    '-92233720368547758.085'::money;

SELECT
    '92233720368547758.075'::money;

-- rounding vs. truncation in division
SELECT
    '878.08'::money / 11::float8;

SELECT
    '878.08'::money / 11::float4;
...
SELECT
    '90000000000000099.00'::money / 10::bigint;

SELECT
    '90000000000000099.00'::money / 10::int;
