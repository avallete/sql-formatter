...
INSERT INTO
    guid1 (guid_field)
VALUES
    ('11111111-1111-1111-1111-111111111111F');
...
INSERT INTO
    guid1 (guid_field)
VALUES
    ('111-11111-1111-1111-1111-111111111111');
...
INSERT INTO
    guid1 (guid_field)
VALUES
    ('11+11111-1111-1111-1111-111111111111');
...
FROM
    guid1
WHERE
    guid_field < '22222222-2222-2222-2222-222222222222';
...
FROM
    guid1 g1
    INNER JOIN guid2 g2 ON g1.guid_field = g2.guid_field;

SELECT
    COUNT(*)
FROM
    guid1 g1
    LEFT JOIN guid2 g2 ON g1.guid_field = g2.guid_field
WHERE
