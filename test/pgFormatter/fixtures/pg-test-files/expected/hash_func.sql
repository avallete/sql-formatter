...
FROM (
        VALUES
            ...
            (42::int2)) x (v)
WHERE
    hashint2 (v)::bit(32) != hashint2extended (v, 0)::bit(32)
    OR hashint2 (v)::bit(32) = hashint2extended (v, 1)::bit(32);

SELECT
    v AS value,
    hashint4 (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            (207112489)) x (v)
WHERE
    hashint4 (v)::bit(32) != hashint4extended (v, 0)::bit(32)
    OR hashint4 (v)::bit(32) = hashint4extended (v, 1)::bit(32);

SELECT
    v AS value,
    hashint8 (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            (207112489)) x (v)
WHERE
    hashint8 (v)::bit(32) != hashint8extended (v, 0)::bit(32)
    OR hashint8 (v)::bit(32) = hashint8extended (v, 1)::bit(32);

SELECT
    v AS value,
    hashfloat4 (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            (207112489)) x (v)
WHERE
    hashfloat4 (v)::bit(32) != hashfloat4extended (v, 0)::bit(32)
    OR hashfloat4 (v)::bit(32) = hashfloat4extended (v, 1)::bit(32);

SELECT
    v AS value,
    hashfloat8 (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            (207112489)) x (v)
WHERE
    hashfloat8 (v)::bit(32) != hashfloat8extended (v, 0)::bit(32)
    OR hashfloat8 (v)::bit(32) = hashfloat8extended (v, 1)::bit(32);

SELECT
    v AS value,
    hashoid (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            (207112489)) x (v)
WHERE
    hashoid (v)::bit(32) != hashoidextended (v, 0)::bit(32)
    OR hashoid (v)::bit(32) = hashoidextended (v, 1)::bit(32);

SELECT
    v AS value,
    hashchar (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('N')) x (v)
WHERE
    hashchar (v)::bit(32) != hashcharextended (v, 0)::bit(32)
    OR hashchar (v)::bit(32) = hashcharextended (v, 1)::bit(32);

SELECT
    v AS value,
    hashname (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('yi3nm0d73')) x (v)
WHERE
    hashname (v)::bit(32) != hashnameextended (v, 0)::bit(32)
    OR hashname (v)::bit(32) = hashnameextended (v, 1)::bit(32);

SELECT
    v AS value,
    hashtext (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('yi3nm0d73')) x (v)
WHERE
    hashtext (v)::bit(32) != hashtextextended (v, 0)::bit(32)
    OR hashtext (v)::bit(32) = hashtextextended (v, 1)::bit(32);

SELECT
    v AS value,
    hashoidvector (v)::bit(32) AS standard,
...
WHERE
    hashoidvector (v)::bit(32) != hashoidvectorextended (v, 0)::bit(32)
    OR hashoidvector (v)::bit(32) = hashoidvectorextended (v, 1)::bit(32);

SELECT
    v AS value,
    hash_aclitem (v)::bit(32) AS standard,
...
FROM (
        ...
        LIMIT
            10) x (v)
WHERE
    hash_aclitem (v)::bit(32) != hash_aclitem_extended (v, 0)::bit(32)
    OR hash_aclitem (v)::bit(32) = hash_aclitem_extended (v, 1)::bit(32);

SELECT
    v AS value,
    hashmacaddr (v)::bit(32) AS standard,
...
WHERE
    hashmacaddr (v)::bit(32) != hashmacaddrextended (v, 0)::bit(32)
    OR hashmacaddr (v)::bit(32) = hashmacaddrextended (v, 1)::bit(32);

SELECT
    v AS value,
    hashinet (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('172.168.10.126/16'),
            ('172.18.103.126/24'),
            ('192.188.13.16/32')) x (v)
WHERE
    hashinet (v)::bit(32) != hashinetextended (v, 0)::bit(32)
    OR hashinet (v)::bit(32) = hashinetextended (v, 1)::bit(32);

SELECT
    v AS value,
    hash_numeric (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            (2071124898672)) x (v)
WHERE
    hash_numeric (v)::bit(32) != hash_numeric_extended (v, 0)::bit(32)
    OR hash_numeric (v)::bit(32) = hash_numeric_extended (v, 1)::bit(32);

SELECT
    v AS value,
    hashmacaddr8 (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('ea:29:b1:5e:1f:a5')) x (v)
WHERE
    hashmacaddr8 (v)::bit(32) != hashmacaddr8extended (v, 0)::bit(32)
    OR hashmacaddr8 (v)::bit(32) = hashmacaddr8extended (v, 1)::bit(32);

SELECT
    v AS value,
    hash_array (v)::bit(32) AS standard,
...
WHERE
    hash_array (v)::bit(32) != hash_array_extended (v, 0)::bit(32)
    OR hash_array (v)::bit(32) = hash_array_extended (v, 1)::bit(32);

SELECT
    v AS value,
    hashbpchar (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('yi3nm0d73')) x (v)
WHERE
    hashbpchar (v)::bit(32) != hashbpcharextended (v, 0)::bit(32)
    OR hashbpchar (v)::bit(32) = hashbpcharextended (v, 1)::bit(32);

SELECT
    v AS value,
    time_hash (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('5:15:59')) x (v)
WHERE
    time_hash (v)::bit(32) != time_hash_extended (v, 0)::bit(32)
    OR time_hash (v)::bit(32) = time_hash_extended (v, 1)::bit(32);

SELECT
    v AS value,
    timetz_hash (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('11:59:59+04')) x (v)
WHERE
    timetz_hash (v)::bit(32) != timetz_hash_extended (v, 0)::bit(32)
    OR timetz_hash (v)::bit(32) = timetz_hash_extended (v, 1)::bit(32);

SELECT
    v AS value,
    interval_hash (v)::bit(32) AS standard,
...
WHERE
    interval_hash (v)::bit(32) != interval_hash_extended (v, 0)::bit(32)
    OR interval_hash (v)::bit(32) = interval_hash_extended (v, 1)::bit(32);

SELECT
    v AS value,
    timestamp_hash (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('2013-08-22 11:59:59+04')) x (v)
WHERE
    timestamp_hash (v)::bit(32) != timestamp_hash_extended (v, 0)::bit(32)
    OR timestamp_hash (v)::bit(32) = timestamp_hash_extended (v, 1)::bit(32);

SELECT
    v AS value,
    uuid_hash (v)::bit(32) AS standard,
...
WHERE
    uuid_hash (v)::bit(32) != uuid_hash_extended (v, 0)::bit(32)
    OR uuid_hash (v)::bit(32) = uuid_hash_extended (v, 1)::bit(32);

SELECT
    v AS value,
    pg_lsn_hash (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('900/F37FD90')) x (v)
WHERE
    pg_lsn_hash (v)::bit(32) != pg_lsn_hash_extended (v, 0)::bit(32)
...
FROM (
        VALUES
            ...
            ('happy')) x (v)
WHERE
    hashenum (v)::bit(32) != hashenumextended (v, 0)::bit(32)
...
SELECT
    v AS value,
    jsonb_hash (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            ('{"g": {"h": "value"}}')) x (v)
WHERE
    jsonb_hash (v)::bit(32) != jsonb_hash_extended (v, 0)::bit(32)
    OR jsonb_hash (v)::bit(32) = jsonb_hash_extended (v, 1)::bit(32);

SELECT
    v AS value,
    hash_range (v)::bit(32) AS standard,
...
FROM (
        VALUES
            ...
            (int4range (1550275, 208112489))) x (v)
WHERE
