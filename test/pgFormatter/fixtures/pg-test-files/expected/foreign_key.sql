...
CREATE TABLE pktable (
    ptest1 int,
    PRIMARY KEY (base1),
    UNIQUE (base1, ptest1)) inherits (pktable_base);
...
CREATE TABLE pktable (
    ...
    FOREIGN key (base2, ptest2) REFERENCES pktable (base1, ptest1)) inherits (pktable_base);

INSERT INTO
    pktable (base1, ptest1, base2, ptest2)
VALUES
    (1, 1, 1, 1);
...
CREATE TABLE pktable (
    ...
    ptest2 inet,
    PRIMARY KEY (base1, ptest1),
    FOREIGN key (base2, ptest2) REFERENCES pktable (ptest1, base1)) inherits (pktable_base);

CREATE TABLE pktable (
    ptest1 inet,
    ptest2 inet,
    PRIMARY KEY (base1, ptest1),
    FOREIGN key (ptest2, base2) REFERENCES pktable (base1, ptest1)) inherits (pktable_base);
...
CREATE RULE r1 AS ON DELETE TO t1 DO
DELETE FROM t2
WHERE
    t2.b = old.a;
...
CREATE TABLE fktable2 (
    ...
    FOREIGN key (
        very_very_long_column_name_to_exceed_63_characters) REFERENCES pktable1,
    FOREIGN key (
        a,
...
CREATE TABLE fk_partitioned_fk (b int, fdrop1 int, a int)
PARTITION BY
    RANGE (a, b);
...
CREATE TABLE fk_partitioned_fk_3_0 PARTITION OF fk_partitioned_fk_3 FOR
VALUES
WITH
    (MODULUS 5, REMAINDER 0);

CREATE TABLE fk_partitioned_fk_3_1 PARTITION OF fk_partitioned_fk_3 FOR
VALUES
WITH
    (MODULUS 5, REMAINDER 1);

ALTER TABLE fk_partitioned_fk ATTACH PARTITION fk_partitioned_fk_3 FOR
VALUES
FROM
    (2000, 2000) TO (3000, 3000);
...
INSERT INTO
    fk_partitioned_fk (a, b)
VALUES
    (500, 501);

INSERT INTO
    fk_partitioned_fk_1 (a, b)
VALUES
    (500, 501);
...
CREATE TABLE fk_partitioned_fk_1 PARTITION OF fk_partitioned_fk FOR
VALUES
FROM
...
CREATE TABLE fk_partitioned_fk (a int DEFAULT 2501, b int DEFAULT 142857)
PARTITION BY
    LIST (a);
...
CREATE TABLE fk_partitioned_fk_2 PARTITION OF fk_partitioned_fk FOR
VALUES
    IN (1500, 1502);
...
CREATE TABLE fk_partitioned_fk_full (x int, y int)
PARTITION BY
    RANGE (x);
...
CREATE TABLE fk_partitioned_fk_4_1 PARTITION OF fk_partitioned_fk_4 FOR
VALUES
FROM
    (1, 1) TO (100, 100);
...
ALTER TABLE fk_partitioned_fk_4 ATTACH PARTITION fk_partitioned_fk_4_2 FOR
VALUES
FROM
    (100, 100) TO (1000, 1000);

ALTER TABLE fk_partitioned_fk ATTACH PARTITION fk_partitioned_fk_4 FOR
VALUES
    IN (3500, 3502);
...
ALTER TABLE fk_partitioned_fk ATTACH PARTITION fk_partitioned_fk_5 FOR
VALUES
    IN (4500);

ALTER TABLE fk_partitioned_fk_5 ATTACH PARTITION fk_partitioned_fk_5_1 FOR
VALUES
FROM
    (0) TO (10);
...
CREATE TABLE fk_partitioned_fk_2_1 PARTITION OF fk_partitioned_fk_2 FOR
VALUES
FROM
    (0) TO (1000);

CREATE TABLE fk_partitioned_fk_2_2 PARTITION OF fk_partitioned_fk_2 FOR
VALUES
FROM
    (1000) TO (2000);
...
CREATE TABLE other_partitioned_fk (a int, b int)
PARTITION BY
    list (a);

CREATE TABLE other_partitioned_fk_1 partition of other_partitioned_fk FOR
VALUES
    IN (2048);

INSERT INTO
    other_partitioned_fk
SELECT
    2048,
    x
FROM
...
PARTITION BY
    list (a)
CREATE TABLE fk_part_1 partition of fk_part (FOREIGN key (a) REFERENCES fkpart0.pkey) FOR
VALUES
    IN (1)
CREATE TABLE fk_part_23 partition of fk_part (FOREIGN key (a) REFERENCES fkpart0.pkey) FOR
VALUES
    IN (2, 3)
PARTITION BY
    list (a)
CREATE TABLE fk_part_23_2 partition of fk_part_23 FOR
VALUES
    IN (2);
...
CREATE TABLE fkpart0.fk_part_4 partition of fkpart0.fk_part FOR
VALUES
    IN (4);
...
CREATE TABLE fkpart0.fk_part_56 partition of fkpart0.fk_part FOR
VALUES
    IN (5, 6)
PARTITION BY
    list (a);

CREATE TABLE fkpart0.fk_part_56_5 partition of fkpart0.fk_part_56 FOR
VALUES
    IN (5);
...
PARTITION BY
    list (a)
CREATE TABLE fk_part_1 partition of fk_part FOR
VALUES
    IN (1)
PARTITION BY
    list (a)
CREATE TABLE fk_part_1_1 partition of fk_part_1 FOR
VALUES
    IN (1);
...
CREATE TABLE fkpart1.fk_part_1_2 partition of fkpart1.fk_part_1 FOR
VALUES
    IN (2);
...
PARTITION BY
    list (a)
CREATE TABLE fk_part_1 partition of fkpart2.fk_part FOR
VALUES
    IN (1)
PARTITION BY
    list (a)
CREATE TABLE fk_part_1_1 (
    a int,
    CONSTRAINT my_fkey FOREIGN key (a) REFERENCES fkpart2.pkey);

ALTER TABLE fkpart2.fk_part_1 attach partition fkpart2.fk_part_1_1 FOR
VALUES
    IN (1);
...
CREATE TABLE fk1 PARTITION OF fk FOR
VALUES
FROM
    (0) TO (750);
...
ALTER TABLE fk ATTACH PARTITION fk2 FOR
VALUES
FROM
    (750) TO (3500);
...
CREATE TABLE pk5 (c int, b int, a int NOT NULL)
PARTITION BY
    RANGE (a);
...
CREATE TABLE fk3 PARTITION OF fk FOR
VALUES
FROM
    (3500) TO (5000);
...
CREATE TABLE droppk1 PARTITION OF droppk FOR
VALUES
FROM
    (0) TO (1000);
...
CREATE TABLE droppk2 PARTITION OF droppk FOR
VALUES
FROM
    (1000) TO (2000)
PARTITION BY
...
CREATE TABLE droppk21 PARTITION OF droppk2 FOR
VALUES
FROM
    (1000) TO (1400);
...
CREATE TABLE pk11 PARTITION OF pk1 FOR
VALUES
    IN (1);
...
CREATE TABLE fk11 PARTITION OF fk1 FOR
VALUES
    IN (1);
...
CREATE TABLE pk2 PARTITION OF pk FOR
VALUES
    IN (2);
...
CREATE TABLE pk31 PARTITION OF pk3 FOR
VALUES
    IN (31);
...
ALTER TABLE pk3 ATTACH PARTITION pk32 FOR
VALUES
    IN (32);

ALTER TABLE pk ATTACH PARTITION pk3 FOR
VALUES
    IN (31, 32);

CREATE TABLE fk2 PARTITION OF fk FOR
VALUES
    IN (2);
...
ALTER TABLE fk ATTACH PARTITION fk3 FOR
VALUES
    IN (3);
...
ALTER TABLE fk ATTACH PARTITION fk4 FOR
VALUES
    IN (50);
...
CREATE TABLE pk12 PARTITION OF pk1 FOR
VALUES
FROM
    (50) TO (100);
...
CREATE TABLE fk12 PARTITION OF fk1 FOR
VALUES
FROM
    (10) TO (100);
...
CREATE TABLE fk (id int, a int DEFAULT 50)
PARTITION BY
    RANGE (a);
...
PARTITION BY
    LIST (a)
CREATE TABLE pkpart1 PARTITION OF pkpart FOR
VALUES
    IN (1);
