...
WHERE
    i.indrelid = 'tbl_include_reg'::regclass
ORDER BY
    c.relname;
...
FROM
    ...
    JOIN pg_class c ON i.indexrelid = c.oid
WHERE
    i.indrelid = 'tbl_include_unique1'::regclass
ORDER BY
    c.relname;
...
FROM
    ...
    JOIN pg_class c ON i.indexrelid = c.oid
WHERE
    i.indrelid = 'tbl_include_pk'::regclass
ORDER BY
    c.relname;
...
FROM
    ...
    JOIN pg_class c ON i.indexrelid = c.oid
WHERE
    i.indrelid = 'tbl_include_box'::regclass
ORDER BY
    c.relname;
