...
SET
    enable_nestloop TO DEFAULT;

SET
    enable_hashjoin TO DEFAULT;

SET
    enable_mergejoin TO DEFAULT;
...
INSERT INTO
    float8range_test
VALUES
    (float8range (-100.00007, '1.111113e9'), 42);
...
INSERT INTO
    i8r_array
VALUES
    (42, ARRAY[int8range (1, 10), int8range (2, 20)]);
