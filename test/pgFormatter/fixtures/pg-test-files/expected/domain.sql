...
INSERT INTO
    basictest
VALUES
    ('88', 'haha', 'short text', '123.12');

-- Bad varchar
INSERT INTO
    basictest
VALUES
    ('88', 'haha', 'short', '123.1212');
...
SELECT
    testtext || testvarchar AS concat,
...
INSERT INTO
    domarrtest
VALUES
    (NULL, '{{"toolong","b","c"},{"d","e","f"}}');

INSERT INTO
    domarrtest (testint4arr[1], testint4arr[3])
VALUES
    (11, 22);
...
INSERT INTO
    dcomptable
VALUES
    (ARRAY[ROW (1, 2)]::dcomptypea);

INSERT INTO
    dcomptable
VALUES
    (ARRAY[ROW (3, 4), ROW (5, 6)]::comptype[]);

INSERT INTO
    dcomptable
VALUES (
        ARRAY[ROW (7, 8)::comptype, ROW (9, 10)::comptype]);
...
INSERT INTO
    dcomptable
VALUES
    (ARRAY[ROW (1, 2)]::comptype[]);

INSERT INTO
    dcomptable
VALUES
    (ARRAY[ROW (2, 1)]::comptype[]);
...
INSERT INTO
    dposintatable
VALUES
    (ARRAY[ARRAY[42]::posint[]]);

-- still fail
INSERT INTO
    dposintatable
VALUES
    (ARRAY[ARRAY[42]::dposinta]);
...
CREATE DOMAIN dcheck varchar(15) NOT NULL CHECK (
    VALUE = 'a'
    OR VALUE = 'c'
    OR VALUE = 'd');
...
--
CREATE FUNCTION sql_is_distinct_from (anyelement, anyelement) returns boolean language sql AS 'select $1 is distinct from $2 limit 1';
...
ALTER TYPE testdomain2
RENAME TO testdomain3;
...
ALTER DOMAIN testdomain1
RENAME CONSTRAINT unsigned TO unsigned_foo;
