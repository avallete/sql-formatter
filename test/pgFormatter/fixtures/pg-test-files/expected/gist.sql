...
CREATE INDEX gist_pointidx2 ON gist_point_tbl USING gist (p)
WITH
    (buffering = ON, fillfactor = 50);

CREATE INDEX gist_pointidx3 ON gist_point_tbl USING gist (p)
WITH
    (buffering = off);

CREATE INDEX gist_pointidx4 ON gist_point_tbl USING gist (p)
WITH
    (buffering = auto);

DROP INDEX gist_pointidx2,
gist_pointidx3,
gist_pointidx4;

-- Make sure bad values are refused
CREATE INDEX gist_pointidx5 ON gist_point_tbl USING gist (p)
WITH
    (buffering = invalid_value);
