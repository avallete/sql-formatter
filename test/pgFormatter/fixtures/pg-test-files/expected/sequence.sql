...
ALTER TABLE serialtest1_f2_seq
RENAME TO serialtest1_f2_foo;
...
WITH
    24 INCREMENT BY 4 MAXVALUE 36 MINVALUE 5 CYCLE;

ALTER SEQUENCE serialTest1 CYCLE;

-- error, not a sequence
CREATE SEQUENCE sequence_test2 START
WITH
    32;
...
-- error
ALTER SEQUENCE sequence_test4 RESTART
WITH
    40;
...
WITH
    -24 START
WITH
    -24 INCREMENT BY -4 MINVALUE -36 MAXVALUE -5 CYCLE;
...
WITH
    32 START
WITH
    32 INCREMENT BY 4 MAXVALUE 36 MINVALUE 5 CYCLE;
...
SET
    LOCAL SESSION AUTHORIZATION regress_seq_user;
...
GRANT
UPDATE ON seq3 TO regress_seq_user;
...
ALTER SEQUENCE sequence_test2 START
WITH
    1;
