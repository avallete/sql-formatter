...
CREATE TRIGGER t BEFORE INSERT ON addr_nsp.gentable FOR EACH ROW
...
ALTER DEFAULT PRIVILEGES FOR ROLE regress_addr_user IN SCHEMA public
GRANT ALL ON TABLES TO regress_addr_user;

ALTER DEFAULT PRIVILEGES FOR ROLE regress_addr_user
...
CREATE TRANSFORM FOR int LANGUAGE SQL (
    ...
    WITH
        ...
        TO SQL
    WITH
        FUNCTION int4recv (internal));

CREATE PUBLICATION addr_pub FOR TABLE addr_nsp.gentable;

CREATE SUBSCRIPTION addr_sub CONNECTION '' PUBLICATION bar
WITH
...
SELECT (
    ...
    ROW (
        ...
        pg_identify_object(addr2.classid, addr2.objid, addr2.objsubid))
FROM
    objects,
