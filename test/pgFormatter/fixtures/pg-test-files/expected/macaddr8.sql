...
SELECT
    '123    08:00:2b:01:02:03'::macaddr8;

-- invalid
SELECT
    '08:00:2b:01:02:03  123'::macaddr8;

-- invalid
SELECT
    '123    08:00:2b:01:02:03:04:05'::macaddr8;

-- invalid
SELECT
    '08:00:2b:01:02:03:04:05  123'::macaddr8;

-- invalid
SELECT
    '08:00:2b:01:02:03:04:05:06:07'::macaddr8;
...
-- invalid
SELECT
    '08002b:01020304050607'::macaddr8;

-- invalid
SELECT
    '08002b01020304050607'::macaddr8;

-- invalid
SELECT
    '0z002b0102030405'::macaddr8;

-- invalid
SELECT
    '08002b010203xyza'::macaddr8;
...
-- true
SELECT
    b::macaddr <> '08:00:2b:01:02:04'::macaddr
FROM
    macaddr8_data
WHERE
    a = 1;
...
-- true
SELECT
    b::macaddr <> '08:00:2b:01:02:03'::macaddr
FROM
    macaddr8_data
WHERE
    a = 1;
