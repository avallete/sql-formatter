...
CREATE TABLE mchash1 PARTITION OF mchash FOR
VALUES
WITH
...
PARTITION BY
    HASH (a part_test_int4_ops, b part_test_int4_ops);
...
CREATE TABLE text_hashp0 partition of text_hashp FOR
VALUES
WITH
    (modulus 2, remainder 0);

CREATE TABLE text_hashp1 partition of text_hashp FOR
VALUES
WITH
