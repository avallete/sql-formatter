...
FROM
    hash_name_heap
WHERE
    hash_name_heap.random = '1505703298'::name;
...
FROM
    hash_name_heap
WHERE
    hash_name_heap.random = '7777777'::name;
...
FROM
    hash_txt_heap
WHERE
    hash_txt_heap.random = '1351610853'::text;
...
FROM
    hash_txt_heap
WHERE
    hash_txt_heap.random = '111111112222222233333333'::text;
...
FROM
    hash_f8_heap
WHERE
    hash_f8_heap.random = '444705537'::float8;
...
FROM
    hash_f8_heap
WHERE
    hash_f8_heap.random = '88888888'::float8;
...
SET
    seqno = 20000
WHERE
    hash_i4_heap.random = 1492795354;
...
SET
    seqno = 20000
WHERE
    hash_name_heap.random = '76652222'::name;
...
SET
    seqno = 20000
WHERE
    hash_txt_heap.random = '959363399'::text;
...
SET
    seqno = 20000
WHERE
    hash_f8_heap.random = '488912369'::float8;
