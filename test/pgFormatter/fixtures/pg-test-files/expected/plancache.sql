...
CREATE TABLE pc_list_part_null partition of pc_list_parted FOR
VALUES
    IN (NULL);

CREATE TABLE pc_list_part_1 partition of pc_list_parted FOR
VALUES
    IN (1);
...
CREATE TABLE pc_list_part_2 partition of pc_list_parted FOR
VALUES
    IN (2);
