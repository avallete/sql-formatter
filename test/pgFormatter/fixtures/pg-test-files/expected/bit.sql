...
SELECT
    POSITION (
        B'000000000011101011111010110' IN B'000000000011101011111010110');

-- 1
SELECT
    POSITION (
        B'00000000011101011111010110' IN B'000000000011101011111010110');

-- 2
SELECT
    POSITION (
        B'0000000000011101011111010110' IN B'000000000011101011111010110');
...
SELECT
    overlay (
        B'0101011100' PLACING '001'
        FROM
            2 FOR 3);

SELECT
    overlay (
        B'0101011100' PLACING '101'
        FROM
            6);
