...
FROM ( (
    ...
    FULL JOIN (
        ...
        FROM
            prt1_e
        WHERE
            prt1_e.c = 0) t3 ON (t1.a = (t3.a + t3.b) / 2)
WHERE
    t1.a = t1.phv
    OR t2.b = t2.phv
    OR (t3.a + t3.b) / 2 = t3.phv
ORDER BY
    t1.a,
    t2.b,
    t3.a + t3.b;
...
FROM
    plt1 t1
    RIGHT JOIN plt2 t2 ON t1.c = t2.c
WHERE
    t1.a % 25 = 0
GROUP BY
    t1.c,
...
FROM
    prt1_m t1
    LEFT JOIN prt2_m t2 ON t1.c = t2.c;
...
FROM
    prt1_n t1
    JOIN prt2_n t2 ON (t1.c = t2.c)
    JOIN plt1 t3 ON (t1.c = t3.c);
...
FROM
    prt1_n t1
    FULL JOIN prt1 t2 ON (t1.c = t2.c);
