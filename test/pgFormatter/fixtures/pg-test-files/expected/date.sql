...
FROM
    DATE_TBL
WHERE
    f1 BETWEEN '2000-01-01' AND '2001-01-01';
...
SELECT
    f1 - date 'epoch' AS "Days From Epoch"
FROM
    DATE_TBL;

SELECT
    date 'yesterday' - date 'today' AS "One day";

SELECT
    date 'today' - date 'tomorrow' AS "One day";

SELECT
    date 'yesterday' - date 'tomorrow' AS "Two days";

SELECT
    date 'tomorrow' - date 'today' AS "One day";

SELECT
    date 'today' - date 'yesterday' AS "One day";

SELECT
    date 'tomorrow' - date 'yesterday' AS "Two days";
...
-- 1001-01-01
SELECT
    DATE_TRUNC('CENTURY', TIMESTAMP '1970-03-20 04:30:00.00000');
...
-- 2001-01-01
SELECT
    DATE_TRUNC('CENTURY', DATE '0002-02-04');
