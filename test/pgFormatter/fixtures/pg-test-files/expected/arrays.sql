...
--
INSERT INTO
    arrtest (a[1:5], b[1:1] [1:2] [1:2], c, d, f, g)
VALUES (
        '{1,2,3,4,5}',
        '{{{0,0},{1,2}}}',
        '{}',
...
FROM (
        SELECT
            ARRAY [
                ...
                [[211, 212], [221, 122], [231, 232]]] AS f) AS t;
...
SELECT
    array_positions (
        ARRAY[1, 2, 3, NULL, 5, 6, 1, 2, 3, NULL, 5, 6],
        NULL);
...
CREATE OR REPLACE FUNCTION unnest1 (anyarray) returns setof anyelement AS $$
