...
CREATE FUNCTION state_update (id int4, new int4) RETURNS int4 AS $$
BEGIN
...
CREATE TYPE foo AS enum('busy', 'help');

CREATE TYPE IF NOT EXISTS foo AS enum('busy', 'help');
