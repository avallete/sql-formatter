...
,
                    CASE library.column4
                        WHEN cheap THEN
                            digits (library.column27) concat library.column28
                        ELSE
                            123456
                    END AS column4,
                ...
                FROM (
                        ...
                        FROM (
                                SELECT
                                    ...
                                    max (
                                        char(alllibrarysales.column4, iso) concat char(alllibrarysales.column5, iso) concat digits (alllibrarysales.column6) concat(alllibrarysales.column7)) AS column5
                                FROM
                                    /*******************     
                                    * This is a block  *    
                                    * comment within a *       
                                    ...
                                    *******************/ (
                                        ...
                                        FROM (
                                                ...
                                                GROUP BY
                                                    tv.column1,
                                                    tv.column2) AS libraryprod,
                                            db1.table2 th
                                        WHERE
                                            th.column1 = libraryprod.column1
                                            AND th.column2 = libraryprod.column2) AS alllibrarysales
                                GROUP BY
                                    alllibrarysales.column1,
