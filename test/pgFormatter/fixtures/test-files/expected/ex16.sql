...
ALTER TABLE new_table_test
ADD CONSTRAINT ck_ansu_fk_org_unit_id CHECK (
    fk_organization_unit_id IS NOT NULL
    AND fk_organization_unit_id > 1000);
...
CREATE TABLE test_boolean (id bigint, is_deleted boolean, is_updated boolean);
