...
--
CREATE FUNCTION
ADD (integer, integer) RETURNS integer LANGUAGE sql IMMUTABLE STRICT AS $_$select $1 + $2;$_$;
...
CREATE FUNCTION check_password (
    ...
    pass8 text,
    uname9 text,
    pass9 text) RETURNS boolean LANGUAGE plpgsql SECURITY DEFINER
SET
    search_path TO admin,
    pg_temp AS $_$
...
ALTER FUNCTION public.check_password (
    ...
    pass8 text,
    uname9 text,
    pass9 text) OWNER TO gilles;

--
-- Name: dup(integer); Type: FUNCTION; Schema: public; Owner: gilles
--
CREATE FUNCTION dup (integer, OUT f1 integer, OUT f2 text) RETURNS record LANGUAGE sql AS $_$ SELECT $1, CAST($1 AS text) || ' is text' $_$;
...
--
CREATE FUNCTION peuple_stock (annee_debut integer, annee_fin integer) RETURNS bigint LANGUAGE plpgsql AS $$
DECLARE
	v_annee integer;
	v_nombre integer;
...
--
CREATE FUNCTION peuple_vin () RETURNS bigint LANGUAGE plpgsql AS $$
DECLARE
...
--
CREATE FUNCTION trous_stock () RETURNS bigint LANGUAGE plpgsql AS $$
DECLARE
	stock_total integer;
	echantillon integer;
...
--
CREATE FUNCTION trous_vin () RETURNS bigint LANGUAGE plpgsql AS $$
DECLARE
	vin_total integer;
	echantillon integer;
	v_vin_id integer;
...
--
CREATE SEQUENCE appellation_id_seq START
WITH
...
CREATE TABLE contenant (
    ...
    libelle text)
WITH
    (autovacuum_enabled = off, fillfactor = '20');
...
--
CREATE SEQUENCE contenant_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE TABLE recoltant (id integer NOT NULL, nom text, adresse text)
WITH
    (autovacuum_enabled = off);
...
--
CREATE SEQUENCE recoltant_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE TABLE region (id integer NOT NULL, libelle text NOT NULL)
WITH
    (autovacuum_enabled = off);
...
--
CREATE SEQUENCE region_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE TABLE type_vin (id integer NOT NULL, libelle text NOT NULL)
WITH
    (autovacuum_enabled = off);
...
--
CREATE SEQUENCE type_vin_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE vin_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER COLUMN id
SET DEFAULT nextval('appellation_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('contenant_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('recoltant_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('region_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('type_vin_id_seq'::regclass);
...
ALTER COLUMN id
SET DEFAULT nextval('vin_id_seq'::regclass);
